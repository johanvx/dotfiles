...
" Colorscheme name
let g:colors_name = 'lettepa-transparent'
...
call s:h('Todo', s:green, s:none, ['bold'])
...
call s:h('StatusLine', s:fg, s:none, ['bold'])
call s:h('StatusLineNC', s:fg0, s:none)
call s:h('StatusLineTerm', s:bg, s:fg)
call s:h('StatusLineTermNC', s:bg, s:fg0)

call s:h('Visual', s:none, s:none, ['bold', 'reverse'])
...
call s:h('Folded', s:blue, s:none, ['reverse'])
...
call s:h('Pmenu', s:fg, s:none)
call s:h('PmenuSel', s:bg, s:fg)
call s:h('PmenuKind', s:fg, s:none)
call s:h('PmenuKindSel', s:bg, s:fg)
call s:h('PmenuExtra', s:fg, s:none)
call s:h('PmenuExtraSel', s:bg, s:fg)
call s:h('PmenuSbar', s:none, s:none)
call s:h('PmenuThumb', s:none, s:fg0)

" Cursor  guifg=bg guibg=fg
" lCursor guifg=bg guibg=fg

call s:h('CursorColumn', s:none, s:none, ['bold'])
call s:h('CursorLine', s:none, s:none, ['bold'])

call s:h('TabLine', s:fg0, s:none)
call s:h('TabLineSel', s:fg, s:none, ['bold'])
